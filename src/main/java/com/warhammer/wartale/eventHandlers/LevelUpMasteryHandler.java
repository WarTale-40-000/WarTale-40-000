...
public class LevelUpMasteryHandler<T extends BaseMasteryComponent>
    implements Consumer<LevelUpMasteryEvent<T>> {
  ...
  public void accept(LevelUpMasteryEvent<T> event) {
    ...
    submessage +=
        "\nGain "
            + (MasteryCalculations.getTotalExperienceForLevel(event.newLevel())
