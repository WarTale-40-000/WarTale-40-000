...
public final class ArmorVariantPage extends InteractiveCustomUIPage<ArmorVariantPage.BindingData> {
  ...
  public ArmorVariantPage(@Nonnull PlayerRef playerRef, @Nonnull CustomPageLifetime lifetime) {
  ...
  @Nonnull
  private PieceView buildPieceView(
      @Nullable InventoryComponent.Armor armor, @Nonnull ArmorPiece piece) {
  ...
  private VariantMatch findVariantMatch(@Nullable ItemStack currentStack) {
    ...
    List<String> variants =
        ArmorVariantStore.getCatalog().findVariantItemIdsExcluding(currentItemId);
  ...
  private static ItemStack createVariantStack(
      @Nonnull String newItemId, @Nonnull Item newItem, @Nullable ItemStack oldStack) {
    ...
    ItemStack newStack =
        new ItemStack(newItemId, quantity, newDurability, newMaxDurability, oldStack.getMetadata());
  ...
  private static ItemStack getArmorStack(
      @Nonnull InventoryComponent.Armor armor, @Nonnull ArmorPiece piece) {
    ItemContainer container = armor.getInventory();
  ...
  private static void writeSnapshot(
      @Nonnull UICommandBuilder patch, @Nonnull PageSnapshot snapshot) {
    writeCurrentSlot(
        patch, "#CurrentHelmetButton", "#CurrentHelmetIcon", snapshot.helmet.currentItemId);
    writeCurrentSlot(
        patch, "#CurrentChestButton", "#CurrentChestIcon", snapshot.chest.currentItemId);
    writeCurrentSlot(
        patch, "#CurrentHandsButton", "#CurrentHandsIcon", snapshot.hands.currentItemId);
  ...
  private static void writeVariantRow(
      @Nonnull UICommandBuilder patch, @Nonnull ArmorPiece piece, @Nonnull PieceView view) {
    String prefix = piece.uiPrefix;
    ...
    writeVariantSlot(
        patch,
        "#" + prefix + "Variant1Button",
        "#" + prefix + "Variant1Icon",
        getOrEmpty(view.visibleVariantItemIds, 0));
    writeVariantSlot(
        patch,
        "#" + prefix + "Variant2Button",
        "#" + prefix + "Variant2Icon",
        getOrEmpty(view.visibleVariantItemIds, 1));
    writeVariantSlot(
        patch,
        "#" + prefix + "Variant3Button",
        "#" + prefix + "Variant3Icon",
        getOrEmpty(view.visibleVariantItemIds, 2));
  }
