...
public class ItemMasteryMappingTable {
    ...
    public static <T extends BaseMasteryComponent> void registerFromWeaponTierMap(
            WeaponMasteryComponent masteryComponent,
            ComponentType<EntityStore, T> type) {
    ...
    public static ComponentType<EntityStore, ? extends BaseMasteryComponent> getMasteryTypeFromItemId(String itemId) {
        return ITEM_TABLE.get(itemId);
    }

    public static ComponentType<EntityStore, ? extends BaseMasteryComponent> getMasteryTypeFromName(String name) {
        switch (name) {
            case "boltpistol":
