...
public class DecrementAmmoInteraction extends SimpleInstantInteraction {
  ...
  public static final BuilderCodec<DecrementAmmoInteraction> CODEC =
  ...
  protected void firstRun(
    ...
    Integer currentAmmoAmount =
        itemStack.getFromMetadataOrNull(WeaponMetadataKey.CURRENT_AMMO.key(), Codec.INTEGER);
